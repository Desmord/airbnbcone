...
const RentModal = () => {
    ...
    const [step, setStep] = useState(STEPS.CATETGORY);
    ...
    const secondaryActionLabel = useMemo(() => {
        ...
        if (step === STEPS.CATETGORY) return undefined
    ...
    return (
        <Modal
            ...
            secondatyAction={step === STEPS.CATETGORY ? undefined : onBack}
